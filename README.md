...
[![godoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://godoc.org/github.com/abhij33t/utls#UConn)
---
...
so you are encouraged to use [godoc](https://godoc.org/github.com/abhij33t/utls#UConn).
...
# Client Hello IDs
See full list of `clientHelloID` values [here](https://godoc.org/github.com/abhij33t/utls#ClientHelloID).  
...
1. Import this library (e.g. `import tls "github.com/abhij33t/utls"`)
